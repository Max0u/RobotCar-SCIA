...
def fire(x, squeeze=32, expand=64):
    left = Conv2D(squeeze, (1,1), activation='elu')(x)
    
    left = Conv2D(squeeze//2, (1,1), activation='elu')(left)
    
    left = Conv2D(squeeze, (3,1), activation='elu')(left)
